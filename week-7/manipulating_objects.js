...
I did not have much trouble passing any of the tests. They were all pretty straightforward. I was unsure if using .name after the
children objects would work, but I ran it once and it seemed to check out.

How difficult was it to add and delete properties outside of the object itself?

It was not very difficult to add/delete properties outside of the object and once I got going the whole
challenge seemed to flow.

What did you learn about manipulating objects in this challenge?

I learned that manipulating objects can be pretty simple as long as you are precise with which object it is that you want to change.
//
//
//
//
